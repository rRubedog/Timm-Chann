...
drone.on("open", (error) => {
  ...
  console.log("Successfully connected to ch");

  const room = drone.subscribe("observable-ch", {
    historyCount: 100,
  });
  room.on("open", (error) => {
    if (error) {
    ...
    console.log("Successfully joined ch");
  });
...
function updateMembersDOM() {
  document.querySelector(".side-count").innerText =
